...
<ol class="flex items-center">
    <li class="relative w-full mb-6">
        ...
        <div class="mt-3">
            <h3 class="font-medium text-gray-900 dark:text-white">Mengikuti Eskul Volly</h3>
        </div>
    </li>
    <li class="relative w-full mb-6">
        <div class="flex items-center">
        ...
        <div class="mt-3">
            <h3 class="font-medium text-gray-900 dark:text-white">Juara 2 Lomba Poster Digital</h3>
        </div>
    </li>
    <li class="relative w-full mb-6">
        <div class="flex items-center">
        ...
        <div class="mt-3">
            <h3 class="font-medium text-gray-900 dark:text-white">Mengikuti Eskul Bulu Tangkis</h3>
        </div>
    </li>
</ol>
    </div>
